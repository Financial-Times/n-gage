...
_verify_stylelint:
	@if [ -e .scss-lint.yml ]; then stylelint $(call GLOB,'*.scss') --config ./.scss-lint.yml && $(DONE); \
	echo "SCSS linting warnings will fail your build onward from 27th November 2017. Here's your grace period for sorting them out. Please consult .scss-lint.yml for more information."; fi
